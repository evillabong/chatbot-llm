<#
.SYNOPSIS
Publica MIMO (capa tenant) localmente en IIS: Mimo.Api + Mimo.App.

.DESCRIPTION
Compila y publica:
- Backend ASP.NET Core (Mimo.Api) en C:\inetpub\mimo.api con binding http://*:4431.
- Frontend Blazor WebAssembly (Mimo.App) en C:\inetpub\mimo.app con binding http://*:8081.
- Artefactos intermedios en .\bin\release\iis-publish\mimo.api y ...\mimo.app.
...
[CmdletBinding()]
param(
    [string]$ApiSiteName = "mimo.api",
    [string]$AppSiteName = "mimo.app",
    [string]$ApiPath = "C:\inetpub\mimo.api",
    [string]$AppPath = "C:\inetpub\mimo.app",
    [int]$ApiPort = 4431,
    [int]$AppPort = 8081,
...
$AppProjectRelative = "src\Mimo.App\Mimo.App.csproj"
