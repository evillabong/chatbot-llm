...
/// <summary>
/// Extrae los claims de un JWT (parte payload) sin validar la firma. La validación
/// criptográfica la hace el backend; el cliente solo usa los claims para UI/autorización local.
/// </summary>
public static class JwtParser
{
    ...
    /// <summary>Lee el claim de expiración (exp, segundos epoch) si está presente.</summary>
