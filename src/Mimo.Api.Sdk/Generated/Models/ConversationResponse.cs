...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Mimo.Api.Sdk.Models.MessageResponse>? Messages { get; set; }
#nullable restore
#else
        public List<global::Mimo.Api.Sdk.Models.MessageResponse> Messages { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Mimo.Api.Sdk.Models.ConversationResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::Mimo.Api.Sdk.Models.ConversationResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Mimo.Api.Sdk.Models.ConversationResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "messages", n => { Messages = n.GetCollectionOfObjectValues<global::Mimo.Api.Sdk.Models.MessageResponse>(global::Mimo.Api.Sdk.Models.MessageResponse.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Mimo.Api.Sdk.Models.MessageResponse>("messages", Messages);
